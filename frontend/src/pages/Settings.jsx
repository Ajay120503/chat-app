...
const Settings = () => {
  ...
  return (
    <div className="min-h-screen container mx-auto px-4 max-w-5xl">
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="rounded-xl border border-base-300 overflow-hidden bg-base-100 shadow-lg max-w-full">
              ...
              <div className="max-w-lg mx-auto">
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden flex flex-col">
                  ...
                  <div className="px-4 py-3 border-b border-base-300 bg-base-100 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Sadhana Jadhav</h3>
